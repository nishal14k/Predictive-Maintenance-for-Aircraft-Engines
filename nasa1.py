...
if __name__ == "__main__":
    filename = "/content/train_FD001[1].txt"
    ...
    # assign stages
    cluster_to_stage = {2: 4, 0: 1, 4: 0, 1: 2, 3: 3}
    stages = np.array([cluster_to_stage[c] for c in clusters])
    # phase 2, SVM model
    rfmodel = trainmodel(data, stages)
...
failureprobs = rfmodel.predict_proba(data)[:, 4]
